...
export default function Services() {
  return (
    <div className="bg-white">
      ...
      <div id="software-development" className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-16 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-md">
            <div className="p-8">
              ...
              <div className="mt-15 relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
                  ...
                  <div className="relative p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-100 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
                    <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 w-16 h-16 rounded-full bg-white border-4 border-blue-100 flex items-center justify-center shadow-sm">
              ...
              <div className="mt-20">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center relative">
                  ...
                  <div className="md:w-1/5 relative z-10 flex flex-col items-center mb-8 md:mb-0">
                    <div className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold shadow-md">1</div>
                  ...
                  {/* Stage 2 */}
                  <div className="md:w-1/5 relative z-10 flex flex-col items-center mb-8 md:mb-0">
                    <div className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold shadow-md">2</div>
                  ...
                  {/* Stage 3 */}
                  <div className="md:w-1/5 relative z-10 flex flex-col items-center mb-8 md:mb-0">
                    <div className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold shadow-md">3</div>
                  ...
                  {/* Stage 4 */}
                  <div className="md:w-1/5 relative z-10 flex flex-col items-center mb-8 md:mb-0">
                    <div className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold shadow-md">4</div>
                  ...
                  <div className="md:w-1/5 relative z-10 flex flex-col items-center">
                    <div className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center text-white font-bold shadow-md">5</div>
              ...
              {/* Success Metrics */}
              <div className="mt-16 overflow-hidden rounded-xl bg-gradient-to-r from-blue-500 to-indigo-600 p-px shadow-lg">
      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="relative mt-16 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-md">
            <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-indigo-500 to-blue-600"></div>
            <div className="p-8">
              <h3 className="text-xl font-semibold text-gray-900">Your Lead Pipeline Visualization</h3>
              
              
              <div className="mt-8 flex flex-col items-center space-y-16 lg:flex-row lg:items-start lg:justify-between lg:space-y-0 lg:space-x-8">
                {/* Step 1: Lead Generation */}
                <div className="relative flex w-full max-w-xs flex-col items-center">
                  <div className="flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-indigo-700 shadow-md">
                  ...
                  <div className="mt-4 w-full rounded-lg bg-gradient-to-r from-indigo-50 to-blue-50 p-4 shadow-sm">
              ...
              {/* Results Section */}
              <div className="mt-20 overflow-hidden rounded-xl bg-gradient-to-r from-indigo-500 via-indigo-600 to-blue-600 p-px shadow-lg">
                <div className="rounded-xl bg-gradient-to-r from-indigo-500 to-blue-600 p-6 text-white backdrop-blur-sm">
      ...
      <div className="bg-gray-50 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-16 relative pb-20">
            {/* SVG Connector Lines - Much more precise than CSS-positioned divs */}
            <svg 
            ...
            <div className="mx-auto max-w-md relative z-10">
              <div className="relative rounded-xl bg-white p-6 shadow-xl">
                {/* Central Circle */}
                <div className="mx-auto flex h-32 w-32 items-center justify-center rounded-full bg-gradient-to-br from-indigo-600 via-purple-500 to-blue-600 shadow-lg">
            ...
            <div className="mt-36 grid gap-6 sm:grid-cols-2 lg:grid-cols-4 relative z-10">
            ...
            <div className="mx-auto mt-20 max-w-5xl">
              <div className="overflow-hidden rounded-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 p-1 shadow-lg">
